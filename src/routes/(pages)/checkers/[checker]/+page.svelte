  ...
  <div class="w-full flex flex-col gap-7.75 p-7.75 py-2">
    <div
      ...
      <div class=" w-full flex gap-4 justify-between items-center text-white text-base">
        <div
          class="w-[82%] flex flex-col gap-4 p-4 rounded-[14px] dark:bg-[#0D0D0D] bg-[#FFFFFF] border border-[#0D0D0D]/5 dark:border-white/5">
          <div class="w-full flex justify-between items-start">
            ...
            <div class="h-full flex justify-center items-center gap-1">
              <div
                class="flex justify-center items-center rounded-lg text-[#2B7FFF] bg-[#2B7FFF]/10 size-6 text-xs border border-[#2B7FFF]/20 cursor-pointer">
                D
              </div>
              <div
                class="flex justify-center items-center rounded-lg bg-white/5 size-6 text-xs bord border-[#2B7FFF]/20 text-white/30 cursor-pointer">
                M
              </div>
              <div
                class="flex justify-center items-center rounded-lg bg-white/5 size-6 text-xs bord border-[#2B7FFF]/20 text-white/30 cursor-pointer">
