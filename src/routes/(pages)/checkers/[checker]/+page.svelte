...
<section class="w-full m-auto h-auto flex flex-col col-span-10 gap-7.75 px-6 sm:p-7.75 sm:py-2">
  <div
    ...
    <div
      class="w-full 3xl:h-13 flex flex-col gap-4 lg:gap-6 lg:flex-row justify-between items-center lg:items-start relative">
            ...
            {#if check}
              <div class="flex flex-col justify-center items-start">
                ...
                <div class="flex justify-between items-center gap-2">
                  <span
                    class="text-base capitalize {check?.status === 'error' ||
                    check?.status === 'down'
                      ? 'text-[#EF4444]'
