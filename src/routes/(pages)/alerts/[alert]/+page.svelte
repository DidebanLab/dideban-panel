              ...
              <a
                href={alert.check_id
                  ...
                  : alert.agent_id
                    ...
                    : '#'}
                class="border ms-2 px-4 py-0.5 text-sm flex justify-center items-center border-[#2B7FFF]/20 text-[#2B7FFF] shadow-lg shadow-[#2B7FFF]/10 bg-[#2B7FFF]/5 rounded-sm text-nowrap"
                >{relationData?.name}</a>
            </span>
          </div>
