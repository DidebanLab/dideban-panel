...
<div
  class="w-full p-[1.2vw] rounded-[14px] bg-white dark:bg-[#0D0D0D] border border-[#0D0D0D]/5 dark:border-white/5">
  <div class="w-full flex justify-between items-start pb-4">
    <div class="flex flex-col gap-1">
      <span class="text-xl dark:text-white">Agents Status</span>
      <span class="text-[0.7vw] text-[#99a1af]">Microservices Health & Availability</span>
    </div>
    <div
  ...
  <div class="w-full grid grid-cols-3 gap-[1.2vw]">
    <div
      ...
      <div class="flex w-full justify-start items-center gap-4">
        ...
        <div class="flex flex-col justify-center items-start gap-1">
          ...
          <span class="text-[0.63vw] text-[#99a1af]">192.168.1.45</span>
        </div>
        <div
          ...
          <span class="text-[0.63vw] text-[#EF4444]">Active</span>
        </div>
      </div>
      <div class="w-full h-36.25 flex flex-col justify-between gap-3">
        <div class="flex flex-col gap-1.5 justify-center">
          <div class="flex justify-between items-start text-[0.63vw]">
        ...
        <div
          class="w-full pt-2 border-t border-[#0D0D0D]/5 dark:border-white/5 flex justify-between items-center text-[#99a1af] text-[0.63vw]">
    ...
    <div
      ...
      <div class="flex w-full justify-start items-center gap-4">
        ...
        <div
          ...
          <span class="text-[0.63vw] text-[#00d492]">Active</span>
        </div>
      </div>
      <div class="w-full h-36.25 flex flex-col justify-between gap-3">
        <div class="flex flex-col gap-1.5 justify-center">
    ...
    <div
      ...
      <div class="flex w-full justify-start items-center gap-4">
        ...
        <div
          ...
          <span class="text-[0.63vw] text-[#F0B100]">Warning</span>
        </div>
      </div>
      <div class="w-full h-36.25 flex flex-col justify-between gap-3">
        <div class="flex flex-col gap-1.5 justify-center">
