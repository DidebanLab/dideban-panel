...
<div class="relative w-full">
    <input
        {...restProps}
        class="dark:border-white/5 border-[#0D0D0D]/10 border w-full text-sm my-2 ltr:pt-3 ltr:pb-2.5 px-2 py-3 h-10 rounded-md focus:outline-2 outline-offset-1 outline-[#e5e5e5] text-[#99a1af] dark:outline-white/5 placeholder:text-[#99a1af]/30 tracking-wide {error
...
{#if error}
    <span in:fade={{ duration: 300 }} class="text-[#F87171] text-xs mb-2">{error}</span>
{/if}
