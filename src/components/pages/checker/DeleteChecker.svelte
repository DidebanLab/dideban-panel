...
<div
  ...
  <div class="flex justify-between items-center w-full">
    ...
    <button
      ...
      class="border cursor-pointer border-red-500/20 rounded-md px-4 py-1.5 text-red-500/70 text-sm ms-auto disabled:border-red-500/10 disabled:text-red-500/30 disabled:cursor-not-allowed"
      >Delete
    </button>
  </div>
  ...
  <div class="flex flex-col justify-start items-start gap-2 py-3 w-full">
    ...
    {#if step === 1}
      <span class="text-[#90A1AF] text-sm"
        >Once you delete a checker, there is no going back. Please be certain.
      </span>
    {:else if step === 2}
      <span class="text-[#90A1AF] text-sm"
