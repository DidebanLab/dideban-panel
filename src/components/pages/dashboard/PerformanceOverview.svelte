...
{#if loading.agents || loading.metrics}
  <div
    ...
    <div
      class="w-full flex flex-col h-auto md:flex-row justify-start md:justify-between lg:justify-start md:items-center gap-1 md:gap-10">
      <div class="bg-white/5 w-50 md:w-59.75 h-4 md:h-13.5 rounded-[10px] animate-pulse"></div>
      <div class="bg-white/5 w-50 md:w-59.75 h-4 md:h-13.5 rounded-[10px] animate-pulse"></div>
      <div class="bg-white/5 w-50 md:w-59.75 h-4 md:h-13.5 rounded-[10px] animate-pulse"></div>
    </div>
    <div
...
{:else}
  <div
    class="w-full h-91.25 sm:h-99.25 md:h-90.25 xl:h-98.75 flex relative justify-center items-center 3xl:w-[65%] 3xl:h-auto rounded-[14px] dark:bg-[#0D0D0D] bg-[#FFFFFF] overflow-hidden text-red-500/50 animate-pulse border border-[#F87171]/15 text-xl">
    <div
