...
<div
  ...
  <div class="relative flex flex-col justify-start items-start p-6 gap-6">
        ...
        <div class="relative w-15 flex">
          <input
            ...
            onblur={e => {
              ...
              else if (value > AGENT_LIMIT.timeoutSeconds.max)
          ...
          <div
           ...
           flex flex-col justify-center items-center gap-2.5 h-full">
            <button
              type="button"
              onclick={() =>
                form.interval < AGENT_LIMIT.intervalSeconds.max && (form.interval += 1)}
              class="size-0.5 flex items-center justify-center
             text-gray-500 hover:text-gray-300 scale-75 cursor-pointer">
              ▲
            </button>
            ...
            <button
              type="button"
              onclick={() =>
                form.interval > AGENT_LIMIT.intervalSeconds.min && (form.interval -= 1)}
              class="size-0.5 flex items-center justify-center
             text-gray-500 hover:text-gray-300 scale-75 cursor-pointer">
              ▼
            </button>
    ...
    <div class="absolute end-6 bottom-7">
